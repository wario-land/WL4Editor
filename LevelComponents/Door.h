...
namespace LevelComponents
{
    ...
    enum DoorType
    {
        ...
        Instant = 2, // Automatically "enter" the door. For example, the edge of a room leading to
                     // another one
    ...
    public:
        ...
        QString GetDoorName()
        {
            return "Room " + QString::number((int) RoomID, 16) + " Door " +
                   QString::number(DoorID, 10);
        }
        ...
        void SetDoorType(enum DoorType _DoorType)
        {
            DoorEntry.DoorTypeByte = (unsigned char) _DoorType;
        }
        ...
        void SetLinkerDestination(int dest_RoomId)
        {
            DoorEntry.LinkerDestination = (unsigned char) dest_RoomId;
        }
        ...
        void SetDoorPlace(unsigned char _X1, unsigned char _X2, unsigned char _Y1,
                          unsigned char _Y2)
        {
            DoorEntry.x1 = _X1;
            DoorEntry.x2 = _X2;

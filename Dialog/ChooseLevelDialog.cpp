...
ChooseLevelDialog::ChooseLevelDialog(struct DialogParams::PassageAndLevelIndex currentSelection,
                                     QWidget *parent) :
        QDialog(parent),
        ui(new Ui::ChooseLevelDialog)
{
    ...
    QStringList
        PassageNameSet; // TODO: read the names directly from the ROM, then we can change the names.

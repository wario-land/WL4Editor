...
/// The parent QWidget.
/// </param>
RoomPreviewGraphicsView::RoomPreviewGraphicsView(QWidget *param) :
        QGraphicsView(param), displayPixmap(0)
{
...
/// </summary>
/// <remarks>
/// If the current options for the graphics view do not include layer 0 with mapping type 0x20, it
/// will not be a viewing option.
/// </remarks>
/// <param name="event">
...
/// </summary>
/// <remarks>
/// Without this override, the graphics view will initialize with the scrollbars in the middle of
/// the scrollable area.
/// </remarks>
/// <param name="event">
...
/// </summary>
/// <remarks>
/// Any parameters equal to the existing instance data pointers in "dataPointers" will not be
/// re-rendered.
/// </remarks>
/// <param name="tileset">
...
/// </param>
void RoomPreviewGraphicsView::UpdateGraphicsItems(LevelComponents::Tileset *tileset, int BGptr,
                                                  int L0ptr)
{
    // Update tilset

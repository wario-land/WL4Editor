...
namespace DialogParams
{
    struct RoomConfigParams
    {
        ...
        RoomConfigParams(LevelComponents::Room *room) :
                ...
                Layer0DataPtr((room->GetLayer0MappingParam() & 0x20) ? room->GetLayerDataPtr(0)
                                                                     : 0),
...
private:
    ...
    static constexpr const char *TilesetNamesSetData[0x5C] = { "00  Debug room",
    ...
    static constexpr const char *LayerPrioritySetData[3] = { "L0 (Top) > L1 > L2 > L3 (Bottom)",
    ...
    static constexpr const char *AlphaBlendAttrsSetData[12] = {
        "No Alpha Blending",  "EVA 44%,  EVB 100%", "EVA 63%,  EVB 100%", "EVA 81%,  EVB 100%",
        "EVA 100%, EVB 100%", "EVA 100%, EVB 0%",   "EVA 81%,  EVB 19%",  "EVA 63%,  EVB 37%",
        "EVA 44%,  EVB 56%",  "EVA 31%,  EVB 68%",  "EVA 19%,  EVB 81%",  "EVA 00%,  EVB 100%"
    };

    // Enumeration of the available layer mapping types
    static constexpr const char *Layer0MappingTypeParamSetData[2] = { "Map16", "Tile8x8" };

    // Enumeration of the available BGs per tileset (RLE format)
    static constexpr const unsigned int BGLayerdataPtrsData[166] = {
        0, // Tileset 0x00
        1,
        WL4Constants::BG_0x5FB2CC,
        1,
        WL4Constants::BG_0x5FB8DC,
        1,
        WL4Constants::BG_0x603064,
        1,
        WL4Constants::BG_0x603064, // 0x04
        1,
        WL4Constants::BG_0x60368C,
        2,
        WL4Constants::BG_0x5FC9A0,
        WL4Constants::BG_0x5FC2D0,
        1,
        WL4Constants::BG_0x6045C4,
        1,
        WL4Constants::BG_0x5FFD94, // 0x08
        0,
        1,
        WL4Constants::BG_0x5FD078,
        1,
        WL4Constants::BG_0x5FD484,
        1,
        WL4Constants::BG_0x603E98, // 0x0C
        0,
        1,
        WL4Constants::BG_0x604ACC,
        3,
        WL4Constants::BG_0x605A7C,
        WL4Constants::BG_0x6063B0,
        WL4Constants::BG_0x606CF4,
        1,
        WL4Constants::BG_0x6074C4, // 0x10
        1,
        WL4Constants::BG_0x5FA6D0,
        1,
        WL4Constants::BG_0x60A1D8,
        1,
        WL4Constants::BG_0x60A1E8,
        1,
        WL4Constants::BG_0x60A4B4, // 0x14
        1,
        WL4Constants::BG_0x6094F4,
        0,
        1,
        WL4Constants::BG_0x6094F4,
        1,
        WL4Constants::BG_0x6094F4, // 0x18
        1,
        WL4Constants::BG_0x6094F4,
        1,
        WL4Constants::BG_0x607CD0,
        1,
        WL4Constants::BG_0x6084DC,
        1,
        WL4Constants::BG_0x608CE8, // 0x1C
        1,
        WL4Constants::BG_0x600388,
        1,
        WL4Constants::BG_0x600EF8,
        2,
        WL4Constants::BG_0x5FD680,
        WL4Constants::BG_0x5FD9BC,
        1,
        WL4Constants::BG_0x6006C4, // 0x20
        1,
        WL4Constants::BG_0x6013D4,
        1,
        WL4Constants::BG_0x601A0C,
        0,
        0, // 0x24
        0,
        2,
        WL4Constants::BG_0x5FE918,
        WL4Constants::BG_0x5FEED8,
        1,
        WL4Constants::BG_0x60221C,
        1,
        WL4Constants::BG_0x5FE540, // 0x28
        1,
        WL4Constants::BG_0x60E860,
        0,
        0,
        0, // 0x2C
        0,
        0,
        1,
        WL4Constants::BG_0x60AD10,
        0, // 0x30
        0,
        0,
        0,
        1,
        WL4Constants::BG_0x5FB8DC, // 0x34
        1,
        WL4Constants::BG_0x5FF264,
        1,
        WL4Constants::BG_0x5FF960,
        2,
        WL4Constants::BG_0x60BC54,
        WL4Constants::BG_0x60B29C,
        1,
        WL4Constants::BG_0x5FF684, // 0x38
        1,
        WL4Constants::BG_0x60ED78,
        0,
        0,
        0, // 0x3C
        0,
        1,
        WL4Constants::BG_0x602858,
        1,
        WL4Constants::BG_0x5FFD94,
        1,
        WL4Constants::BG_0x600EF8, // 0x40
        1,
        WL4Constants::BG_0x609A84,
        1,
        WL4Constants::BG_0x60E860,
        1,
        WL4Constants::BG_0x60E96C,
        1,
        WL4Constants::BG_0x60E860, // 0x44
        2,
        WL4Constants::BG_0x60CF98,
        WL4Constants::BG_0x60C5FC,
        1,
        WL4Constants::BG_0x60E044,
        1,
        WL4Constants::BG_0x5FA6D0,
        1,
        WL4Constants::BG_0x60E860, // 0x48
        1,
        WL4Constants::BG_0x60E860,
        1,
        WL4Constants::BG_0x60E96C,
        ...
        WL4Constants::BG_0x60E96C,
        1,
        WL4Constants::BG_0x60E96C, // 0x4C
        1,
        WL4Constants::BG_0x60E96C,
        1,
        WL4Constants::BG_0x60E96C,
        1,
        WL4Constants::BG_0x60E870,
        1,
        WL4Constants::BG_0x5FA6D0, // 0x50
        1,
        WL4Constants::BG_0x5FE008,
        1,
        WL4Constants::BG_0x5FD484,
        1,
        WL4Constants::BG_0x60A350,
        1,
        WL4Constants::BG_0x60A1E8, // 0x54
        1,
        WL4Constants::BG_0x60A1E8,
        1,
        WL4Constants::BG_0x605270,
        0,
        0, // 0x58
        0,
        0,

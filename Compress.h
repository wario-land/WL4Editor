...
namespace ROMUtils
{
    ...
    protected:
        ...
        virtual void AddOpcode(QVector<unsigned char> &compressedData, unsigned short opcode,
                               bool runmode) = 0;
    ...
    public:
        RLEMetadata8Bit(void *data, unsigned int len) : RLEMetadata(data, len)
        {
            InitializeJumpTable();
        }
    ...
    public:
        RLEMetadata16Bit(void *data, unsigned int len) : RLEMetadata(data, len)
        {
            InitializeJumpTable();
        }

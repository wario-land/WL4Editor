...
EditModeDockWidget::EditModeDockWidget(QWidget *parent) :
        QDockWidget(parent), ui(new Ui::EditModeDockWidget)
{
    ui->setupUi(this);
    ...
    ui->dockWidgetContents->setFixedHeight(
        20 * rowHeight); // TODO: Make this exact, calculate using margins
}
...
{
    (void) arg1;
    if (ui->CheckBox_Layer0View->isChecked() &&
        singleton->GetCurrentRoom()->IsLayer0ColorBlendingEnabled())
    {

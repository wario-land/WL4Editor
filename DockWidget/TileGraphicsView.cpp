...
static bool initialized =
    false; // Used to allow the vertical scrollbar to initialize to the top once.
...
/// </summary>
/// <remarks>
/// Without this override, the graphics view will initialize with the vertical scrollbar halfway
/// down.
/// </remarks>
/// <param name="event">
